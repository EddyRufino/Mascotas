...
<body>
    ...
    <footer class="bg-primary pt-4 pb-2 text-white pb-3">
        <div class="text-center">
            <h5 class="font-weight-bold mb-3">Muni Castilla</h5>
            <div>
                <p>
                    <a class="text-white" target="_blank" href="https://municastilla.gob.pe/wp/ordenanzas-municipales/">Normal Legal</a> |
                    <a class="text-white" target="_blank" href="https://municastilla.gob.pe/legal/">Política de Privacidad</a>
                </p>
            </div>
            <p>© 2019 - {{ date('Y') }} <strong class="text-white">·</strong> <a class="text-white" href="https://municastilla.gob.pe/wp/">Municastilla.gob.pe</a></p>
